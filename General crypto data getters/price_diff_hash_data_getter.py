...
for coin in coins:
    for chart_name in charts:
        chart_dfs[coin][chart_name].to_csv('C:\\Users\\Ben\\Desktop\\Python\\Sublime\\Dissertation\\Data Storage\\Price_diff_hash_data\\3month_'+coin+'_'+chart_name+'_'+date_num+'.csv')
...
date_num = str(datetime.datetime.now().day)+'_'+ str(datetime.datetime.now().month)
ada.to_csv('C:\\Users\\Ben\\Desktop\\Python\\Sublime\\Dissertation\\Data Storage\\Price_diff_hash_data\\max_'+'cardano'+'_'+'exchange-rate'+'_'+date_num+'.csv')
...
date_num = str(datetime.datetime.now().day)+'_'+ str(datetime.datetime.now().month)
ripple.to_csv('C:\\Users\\Ben\\Desktop\\Python\\Sublime\\Dissertation\\Data Storage\\Price_diff_hash_data\\max_'+'ripple'+'_'+'exchange-rate'+'_'+date_num+'.csv')